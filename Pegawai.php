...
class Pegawai{
    ...
    // public function tunjangan_jabatan($tunjab){
    //     $this->jabatan = $gapok * 0.2;
    // }
    // public function tunjangan_jabatan($tunjab){
    //     $this->jabatan = $tunjab;
    //     switch($tunjab){
    //         case 'Manager': $gapok = 15000000 * 0.2; break;
    //         case 'Asisten Manager': $gapok = 10000000 * 0.2; break;
    //         case 'Kepala Bagian': $gapok = 7000000 * 0.2; break;
    //         case 'Staff': $gapok = 5000000 * 0.2; break;
    //         default: $gapok;
    //     }
    //     return $gapok;
    // }
    // public function tunjangan_keluarga($tunkel){
    //     $this->status = $tunkel;
    //     switch($tunkel){
    //         case 'Manager': $gapok = 15000000; break;
    //         case 'Asisten Manager': $gapok = 10000000; break;
    ...
    //     return $gapok;
    //     }
    //     $tunkel = ($status['status']) ? 'Menikah' : 'Belum Menikah';
    //     if ($status == 'Menikah'){
    //         return $gapok * 0.1;
    //     }
    //     else {
