...
<div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                DataTable Example -->
                                <!-- Membuat tombol mengarahkan ke file pelanggan_form.php -->
                                <a href="index.php?url=pelanggan_tambah" class="btn btn-primary btn-sm" >Tambah</a>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $row['kartu_id'] ?></td>
                                            <td>
                                                <form action="controller/pelanggan_con.php" method="POST">
                                                    <a href="index.php?url=pelanggan_detail&id=<?= $row ['id'] ?>" class="btn btn-info btn-sm" >Detail</a>
                                                    <a href="index.php?url=pelanggan_update&idedit=<?= $row ['id'] ?>" class="btn btn-warning btn-sm" >Ubah</a>
