...
<div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                DataTable Example -->
                                <!-- Membuat tombol mengarahkan ke file kartu_form.php -->
                                <a href="index.php?url=kartu_tambah" class="btn btn-primary btn-sm" >Tambah</a>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="controller/kartu_con.php" method="POST">
                                                    ...
                                                    <a href="index.php?url=kartu_update&idedit=<?= $row ['id'] ?>" class="btn btn-warning btn-sm" >Ubah</a>
