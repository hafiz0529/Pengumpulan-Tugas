<?php
error_reporting(0);
    $objek_pelanggan = new Pelanggan();
    $data_pelanggan = $objek_pelanggan->dataPelanggan();
    $idEdit = $_REQUEST['idedit'];
    $pelanggan = !empty($idEdit) ? $objek_pelanggan->getPelanggan($idEdit) : array();
?>
...
<form action="controller/pelanggan_con.php" method="POST">
      ...
      <div class="form-group row">
        <label for="text2" class="col-4 col-form-label">JK</label> 
        <div class="col-8">
